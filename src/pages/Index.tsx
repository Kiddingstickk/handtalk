...
const Index = () => {
  return (
    <>
      <Helmet>
        {/* ✅ Title */}
        <title>Handtalk Barber | Premium Men's Barbershop in New York</title>

        {/* ✅ Meta Description */}
        <meta
          name="description"
          content="Experience precision cuts, modern styling, and classic grooming at Handtalk Barber. Premium barbershop in New York City. Book your appointment today."
        />

        {/* ✅ Keywords */}
        <meta
          name="keywords"
          content="Handtalk Barber, barbershop, men's grooming, haircuts, beard trim, hot towel shave, New York barber"
        />

        {/* ✅ Canonical URL */}
        <link rel="canonical" href="https://handtalkbarber.com" />

        {/* ✅ Open Graph */}
        <meta property="og:title" content="Handtalk Barber | Premium Men's Barbershop" />
        <meta
